    ...
    async (
      ...
      try {
        ...
        return {
          ...
          surfaceBreakdown: {
            pavement: result.surface_breakdown?.paved || 0,
            gravel: (result.surface_breakdown?.gravel || 0) + (result.surface_breakdown?.unpaved || 0),
            dirt: result.surface_breakdown?.ground || 0,
            singletrack: 0,
            unknown: result.surface_breakdown?.unknown || 100,
          },
        };
      } catch (error) {
