...
from app.schemas.route import RouteCandidateResponse, SegmentedSurfaceData, ElevationPoint
...
class RouteData(BaseModel):
    ...
    segmented_surface: Optional[SegmentedSurfaceData] = None  # Segment-level surface data
    elevation_profile: Optional[List[ElevationPoint]] = None  # Elevation profile points
    transition_segments: Optional[List[Dict[str, Any]]] = None  # Connector segments metadata


class PlanningMeta(BaseModel):
    """Metadata about planning execution and fallbacks."""
...
class ChatResponse(BaseModel):
    ...
    # Planning metadata
    planning_meta: Optional[PlanningMeta] = None
