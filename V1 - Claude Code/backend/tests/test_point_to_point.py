...
class MockRoutingService:
    ...
    VALHALLA_PROFILES = {SportType.ROAD: "bicycle"}

    def __init__(self):
        self.graphhopper_api_key = None
        self.valhalla_api_key = None
    ...
    async def _call_brouter_interactive(self, *args, **kwargs):
        return {"features": []}

    def _parse_brouter_response(self, _response, _profile="fastbike"):
        return self._parse_ors_response(_response)

    async def _attach_valhalla_surface(self, parsed, _profile):
        return parsed
