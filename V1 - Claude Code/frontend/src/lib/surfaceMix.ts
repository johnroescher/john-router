 ...
 * 
 * IMPORTANT: 
 * - unknown is kept separate, NOT added to paved.
 *   This was a critical bug that caused all routes to appear 100% paved.
 * - gravel, dirt, and singletrack are all treated as "unpaved" (combined together).
 *   They are not distinguished in the simplified view.
 */
 ...
 * 
 * NOTE: gravel, dirt, and singletrack all map to "unpaved" - they are treated identically.
 */
