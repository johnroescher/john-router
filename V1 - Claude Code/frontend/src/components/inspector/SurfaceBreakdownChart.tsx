...
export default function SurfaceBreakdownChart() {
  ...
  const { segmentedSurface, isEnriching, aggregatedBreakdown } = useSurfaceStore();
  ...
  // Use the reactive aggregatedBreakdown from the store
  const rawSurfaceBreakdown = useMemo(() => {
