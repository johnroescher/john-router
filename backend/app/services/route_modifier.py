...
class RouteModifier:
    ...
    async def modify_route(
        ...
        mod_intent = self._parse_modification_intent(modification_request, original_intent)
        ...
        if similarity_score is not None and mod_intent.change_intent.strategy == "modify_existing":
            if similarity_score < 0.5:
                return None, None, similarity_score, (
                    "I couldn't keep the route close to the original while honoring that request."
                )
